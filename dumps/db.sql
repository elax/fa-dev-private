...
INSERT INTO `0_sys_prefs` VALUES ('coy_name','setup.company','varchar',60,'Test');
...
--
-- Table structure for table `0_tax_rep`
--
...
CREATE TABLE `0_tax_rep` (
  ...
  `basis` varchar(10) NOT NULL DEFAULT '0',
  `balancing_journal` tinyint(1) NOT NULL DEFAULT '0',
  `liability_account` varchar(15) NOT NULL DEFAULT '',
  `tax_payment` tinyint(1) NOT NULL DEFAULT '0',
  `bank_account` varchar(15) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `0_tax_rep`
--

LOCK TABLES `0_tax_rep` WRITE;
/*!40000 ALTER TABLE `0_tax_rep` DISABLE KEYS */;
/*!40000 ALTER TABLE `0_tax_rep` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `0_tax_rep_line`
--
...
CREATE TABLE `0_tax_rep_line` (
  ...
  `code` varchar(50) NOT NULL DEFAULT '',
  `description` varchar(100) NOT NULL DEFAULT '',
  `line_type` varchar(15) NOT NULL DEFAULT '0',
  `calculation` varchar(255) NOT NULL DEFAULT '',
  `code_basis` varchar(20) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `0_tax_rep_line`
--

LOCK TABLES `0_tax_rep_line` WRITE;
/*!40000 ALTER TABLE `0_tax_rep_line` DISABLE KEYS */;
/*!40000 ALTER TABLE `0_tax_rep_line` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `0_tax_rep_line_accounts`
--
...
--
-- Dumping data for table `0_tax_rep_line_accounts`
--

LOCK TABLES `0_tax_rep_line_accounts` WRITE;
/*!40000 ALTER TABLE `0_tax_rep_line_accounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `0_tax_rep_line_accounts` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `0_users` VALUES (1,'admin','5f4dcc3b5aa765d61d8327deb882cf99','Administrator',2,'','adm@adm.com','',0,0,0,0,'default','Letter',2,2,4,1,1,0,0,'2013-11-22 00:57:44',10,1,1,'1',1,0,'orders',0);
...
-- Dump completed on 2013-11-22 13:58:22
